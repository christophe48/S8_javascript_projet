#Aujourd'hui nous voyons les bases de JS:
Appuie sur la touche pour voir dans la console :
Sous Linux : F12 puis onglet "console"
Sous Mac : ALT + CMD + I

A droite de "éléments" tu as "console" TOUT SE PASSE ICI !

Dans le fichier _Index.html_ tu as tout en commentaires enlèvent les 1/1 pour voir exo/exo
